...
import { CreditCard, Download, Menu, X, Code2 } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <Button
                  className="bg-blue-700 hover:bg-blue-800 text-white font-weight-600 uppercase "
                  onClick={onDownload}
                  size="lg"
                >
                  <Download className="mr-2 h-4 w-4" />
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="font-weight-600 uppercase ml-4 "
